;(function(freeElectron,undefined){
	freeElectron.draw = (function () {
		function _drawing(){
			console.log(freeElectron)
			var ctx = freeElectron.context || {},
			canvas = freeElectron.canvas || {};
