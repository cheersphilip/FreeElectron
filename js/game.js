;(function(freeElectron, undefined){
	// Create the canvas
	freeElectron.canvas = document.createElement("canvas");
	freeElectron.ctx = freeElectron.canvas.getContext("2d");
	freeElectron.lockWidth = Math.floor(window.innerWidth/20);
	freeElectron.blockHeight = Math.floor(window.innerHeight/12);
	var b = freeElectron.blockHeight > freeElectron.blockWidth ? freeElectron.blockWidth: freeElectron.blockHeight;

	freeElectron.canvas.width = b*20;
	freeElectron.canvas.height = b*12;
	document.body.appendChild(freeElectron.canvas);
	...
	//drawing reference
	var drawActive = freeElectron.draw.drawActive,
		drawBackground = freeElectron.draw.drawBackground,
		drawDeathScene = freeElectron.draw.drawDeathScene,
		drawElectron = freeElectron.draw.drawElectron,
		drawEndScreen = freeElectron.draw.drawEndScreen,
		drawExit = freeElectron.draw.drawExit,
		drawHealth = freeElectron.draw.drawHealth,
		drawScore = freeElectron.draw.drawScore,
		drawStartScreen = freeElectron.draw.drawStartScreen,
		drawWall = freeElectron.draw.drawWall;

	//levels
	var levels = freeElectron.map.levels,
		currentLevel = 0,
		deathStartTime = 0,
		deathElapsedTime = 0
		deathDuration = 500;
